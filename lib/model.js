...
Model.prototype.parse = function(html){
  ...
  if (this.definition.type === 'collection')
    return this._parseCollection($);

  if (this.definition.type === 'item')
...
Model.prototype._applyFilters = function(item){
  ...
  if (this.definition.validate(item))
    return this.definition.format(item);
  else
    return null;
};
...
Model.prototype._parseIteration = function($){
  ...
  return $(this.definition.iterate).map(function(key, val){
...
Model.prototype._parseItem = function($){
  ...
  return _.mapValues(self.definition.elements, function(element){
